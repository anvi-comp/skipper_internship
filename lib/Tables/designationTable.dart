...
class designationTable extends StatefulWidget {
  const designationTable({Key? key, required String title}) : super(key: key);

  @override
  _DocumentsPageTableState createState() => _DocumentsPageTableState();
}

class _DocumentsPageTableState extends State<designationTable> {
  final List<Map> _desData = List.generate(5, (i) {
    return {
      "id": i,
      "Designation Name": "Dept $i",
      "Description": "Desc $i",
      "Department": "Dept $i",
      "Status": "Active",
      "columnEdit": false
