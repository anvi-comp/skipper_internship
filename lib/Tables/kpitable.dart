...
class kpitable extends StatefulWidget {
  const kpitable({Key? key, required String title}) : super(key: key);

  @override
  _DocumentsPageTableState createState() => _DocumentsPageTableState();
}

class _DocumentsPageTableState extends State<kpitable> {
  final List<Map> _desData = List.generate(5, (i) {
    return {
      "id": i,
      "Name of the KPI": "Dept $i",
      "Description": "Desc $i",
      "Status": "Active",
      "columnEdit": false
    };
