  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: Container(
            ...
            child: countryPageForm()));
  }
}

/// Table

class countryPageForm extends StatefulWidget {
  const countryPageForm({Key? key}) : super(key: key);

  @override
  State<countryPageForm> createState() => _countryPageFormState();
}

class _countryPageFormState extends State<countryPageForm> {
  ...
  getCategory() async {
    var response = await httpService.getData('country');
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      httpService.postData("country", FormData);
                      FormData.clear();
                    },
                    child: const Center(
                      child: Text(
