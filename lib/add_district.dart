  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: Container(
            ...
            child: DistrictPageForm()));
  }
}

/// Table

class DistrictPageForm extends StatefulWidget {
  const DistrictPageForm({Key? key}) : super(key: key);

  @override
  State<DistrictPageForm> createState() => _DistrictPageFormState();
}

class _DistrictPageFormState extends State<DistrictPageForm> {
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      httpService.postData("districts", FormData);
                      FormData.clear();
                    },
                    child: const Center(
                      child: Text(
