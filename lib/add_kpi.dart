...
class kpiPageForm extends StatefulWidget {
  const kpiPageForm({Key? key}) : super(key: key);

  @override
  State<kpiPageForm> createState() => _kpiPageFormState();
}

class _kpiPageFormState extends State<kpiPageForm> {
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      httpService.postData("kpi", FormData);
                      FormData.clear();
                    },
                    child: const Center(
                      child: Text(
