...
import 'package:retry_forms/state.dart';

class documentPage extends StatefulWidget {
  const documentPage({Key? key, required String title}) : super(key: key);

  @override
  _DocumentsPageFormState createState() => _DocumentsPageFormState();
}

class _DocumentsPageFormState extends State<documentPage> {
                            ...
                            child: Align(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => const state(title: '',)),
                                      );
                                    },
                                    child: const Align(
                                      child: Text('Submit'),
