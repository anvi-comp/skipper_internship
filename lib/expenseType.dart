...
class expenseType extends StatefulWidget {
  const expenseType({Key? key, required String title}) : super(key: key);

  @override
  _ExpenseTypeFormState createState() => _ExpenseTypeFormState();
}

class _ExpenseTypeFormState extends State<expenseType> {
                            ...
                            child: Align(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => const kpi(title: '',)),
                                      );
                                    },
                                    child: const Align(
                                      child: Text('Submit'),
