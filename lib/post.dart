...
class MyApp extends StatelessWidget {
  ...
  static final CREATE_POST_URL = 'https://jsonplaceholder.typicode.com/posts';//setting url for api call
  TextEditingController titleControler = new TextEditingController();//controllers for data
